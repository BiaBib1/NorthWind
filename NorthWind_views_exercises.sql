...
-- VW_VENTA_MES - EVOLUCION MENSUAL DE VENTAS
...
-- VW_VENTAS_DIARIAS - Tendencia de los ultimos 30 días
...
-- VENDITE POR EMPLEADO
/* Esta vista muestra las ventas totales por empleado, ordenadas por el total de ventas. 
*/
...
/* Esta vista muestra los productos más vendidos, ordenados por la cantidad total vendida. 
*/
...
-- VENDITE PER CLIENTE
/* Esta vista muestra las ventas totales por cliente, ordenadas por el total de ventas. 
*/
...
-- vw_ventas_categoria - Distribución de ventas por categoría
